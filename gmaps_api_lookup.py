#!/usr/bin/python3
""" Geolocation via Google Maps API following Barron Stone course for Code Clinic: Python in Lynda.com"""
...
API_KEY = 'AIzaSyAa0qu5s3rM-DkOiAGLvADWygiUQqY2JZs' # replace with your own Google Maps API key
